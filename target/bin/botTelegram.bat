...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="botTelegram" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.company.Main %CMD_LINE_ARGS%
